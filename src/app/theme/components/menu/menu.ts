...
export const verticalMenuItems = [ 
    ...
    new Menu (2, 'Police Officers', '/users', null, 'users', null, false, 0), 
    new Menu (3, 'Police Stations', null, null, 'th-large', null, true, 0),   
    new Menu (4, 'Book Case', '/stations/case', null, 'address-card-o', null, false, 3), 
    new Menu (5, 'Manage OB Records', '/stations/ob-records', null, 'th-large', null, false, 3),  
    new Menu (6, 'Manage Cells', '/stations/cells', null, 'creative-commons', null, false, 3),
    new Menu (7, 'Case Status', null, null, 'exclamation-circle', null, true, 3), 
    //new Menu (10, 'Bail', null, null, 'font-awesome', null, true, 7), 
    new Menu (10, 'Released on Bail', '/bails/pending', null, 'anchor', null, false, 7), 
    //new Menu (14, 'Released on Bail', '/bails/released-bail', null, 'fist-raised', null, false, 10), 
    new Menu (11, 'Waiting for Court', '/bails/hearing', null, 'balance-scale', null, false, 7),
    
    new Menu (8, 'Station Officers', '/stations/station-officers', null, 'th-list', null, false, 3), 
    new Menu (9, 'Case Members', '/stations/media-objects', null, 'object-group', null, false, 3), 
    new Menu (12, 'In Custody', '/stations/arrested', null, 'ban', null, false, 3), 
    //new Menu (21, 'Released on Bail', '/stations/arrested', null, 'font-awesome', null, false, 3), 
    // new Menu (10, 'Tabs & Accordions', '/stations/tabs-accordions', null, 'server', null, false, 3),
    ...
    new Menu (16, 'Courts', null, null, 'briefcase', null, true, 0),
    new Menu (17, 'Court Officials', '/courts/officials', null, 'envelope-o', null, false, 16),
    



    new Menu (20, 'Configurations', null, null, 'gear', null, true, 0), 
    new Menu (21, 'Manage Stations', '/settings/manage-stations', null, 'pencil', null, false, 20),
    new Menu (22, 'Manage Cells', '/settings/manage-cells', null, 'pencil', null, false, 20),
    new Menu (23, 'Manage Courts', '/settings/manage-courts', null, 'pencil', null, false, 20),
    new Menu (24, 'Case Types', '/settings/case-types', null, 'pencil', null, false, 20),
    new Menu (25, 'Manage Counties', '/settings/manage-counties', null, 'pencil', null, false, 20),
    new Menu (26, 'Reports', null, null, 'table', null, true, 0),
    new Menu (27, 'Basic Tables', '/reports/basic-tables', null, 'th', null, false, 26), 
    new Menu (28, 'Dynamic Tables', null, null, 'th-large', null, true, 26), 
    new Menu (29, 'Smart DataTable', '/reports/dynamic-tables/smart', null, 'caret-right', null, false, 28),
    ...
    // new Menu (50, 'Calendar', '/calendar', null, 'calendar', null, false, 0), (click)="onConfirm()"
...
export const horizontalMenuItems = [ 
    new Menu (1, 'Dashboard', '/', null, 'tachometer', null, false, 0),
    new Menu (2, 'Users', '/users', null, 'users', null, false, 0), 
